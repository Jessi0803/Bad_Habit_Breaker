...
- [ ] Freemium model (3 interventions/day free)
- [ ] Premium voices (celebrity clones)
...
**Team Size:** 4 members (hackathon team)

**Roles:**
- Backend development (Node.js + APIs)
- Frontend development (Chrome Extension)
- AI/LLM integration (Groq + ElevenLabs)
...
- **ElevenLabs** - Incredible voice synthesis quality
...
- Winston Churchill speeches (public domain)
- RescueTime, Freedom, Cold Turkey (productivity apps)
...
- **GitHub:** https://github.com/Jessi0803/Bad_Habit_Breaker
- **Demo Video:** [Coming soon]
- **Hackathon:** https://hackathon.elevenlabs.io/

---

## 🎉 Quick Start for Judges

**Want to see it in action in 60 seconds?**
...
2. **Extension:**
   ...
   - Select 🇬🇧 Churchill voice
   - Visit Instagram

3. **Magic happens!** ✨

**That's it! Churchill will personally stop your procrastination!**

---

<div align="center">

### 🇬🇧 "We shall fight on the beaches of productivity!" 🇬🇧

**Built with ❤️ for ElevenLabs Hackathon**
